// utils/lunarCalendar.js - Chuyển đổi dương lịch sang âm lịch Việt Nam
// Dựa trên thuật toán của Lê Thành Trọng
...
// Tìm ngày bắt đầu tháng âm lịch chứa ngày Julian jd
...
export function solar2lunar(dd, mm, yy, timeZone = 7) {
...
export function lunar2solar(lunarDay, lunarMonth, lunarYear, lunarLeap = 0, timeZone = 7) {
  let a11, b11;
  if (lunarMonth < 11) {
