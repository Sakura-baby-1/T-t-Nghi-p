...
// Màn hình chi tiết sự kiện với màu động theo lịch
...
const getCalendarIcon = (key) => {
  ...
  // 🎇 Danh sách emoji fallback siêu đẹp – Hoàng Gia Tết 2026
      ...
      >
        <SafeAreaView style={{flex:1}}>
          ...
          <ScrollView contentContainerStyle={styles.container}>
            {/* Tiêu đề sự kiện nổi bật với animation */}
            <LinearGradient 
              colors={isDarkMode 
            ...
            {/* Thẻ lịch nổi bật với animation */}
            <LinearGradient 
            ...
            >
              <View style={styles.calendarContent}>
                ...
                <View style={{flex: 1}}>
                  <Text style={styles.calendarLabel}>📂 LỊCH</Text>
            ...
            <View style={[styles.infoCard, {backgroundColor: isDarkMode ? palette?.card : 'rgba(255,255,255,0.95)', borderColor: baseColor}]}>
              ...
              {event.thongBao && event.thongBao !== 'Không thông báo' && (
                <View style={styles.infoRow}>
